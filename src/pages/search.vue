<template>
	<div v-infinite-scroll="loadmore" infinite-scroll-disabled="busy" infinite-scroll-distance="10" style="padding-top:40px">
		<form @submit="search(true,false)" id="searchform">
			<label><input type="search" v-model="value" required :value="value" autofocus="autofocus" placeholder="搜索音乐、电台、歌手"/><span @click="$router.back()">取消</span></label>
		</form>
